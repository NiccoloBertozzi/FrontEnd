<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutputTorneiDelegato.aspx.cs" Inherits="test.OutputTorneiDelegato" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-title row">
            <h1 class=" col-12 text-center my-auto">I tuoi tornei</h1>
        </div>
