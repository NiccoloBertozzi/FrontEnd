...
<head runat="server">
    ...
    <title>Tornei - non autorizzati</title>
    ...
    <script>
        $(document).ready(function () {
            ...
            var settings = {
                "url": "https://aibvcapi.azurewebsites.net/api/v1/tornei/GetTorneiNonAutorizzati",
                "method": "GET",
                "timeout": 0,
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row mt-3 mb-3">
            <h1 class=" col-12 text-center my-auto banner">Tornei non autorizzati</h1>
        </div>
