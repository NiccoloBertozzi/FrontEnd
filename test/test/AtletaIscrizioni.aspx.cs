...
namespace test
{
    public partial class AtletaIscrizioni : System.Web.UI.Page
    {
        string token;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                //richiama il metodo per scaricare i tornei a cui l'atleta è iscritto e stamparli
                DownloadListaIscrizioni(token);
            }
        }

        protected void DownloadListaIscrizioni(string token)
        {
            //CODICE GENERATO DA POSTMAN
